    ...
    <header className="bg-slate-700/50 backdrop-blur-sm border-b border-slate-600 sticky top-0 z-50">
      <div className="px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between gap-4">
        ...
        <button
          ...
          className="md:hidden flex items-center gap-1 px-2 py-1 bg-red-600 hover:bg-red-700 text-white rounded text-[10px] font-bold transition-all hover:scale-105"
        >
      ...
      {mobileSearchOpen && (
        <div className="md:hidden border-t border-slate-600 bg-slate-800/50 px-4 py-3">
          <SearchBar />
        </div>
      )}
