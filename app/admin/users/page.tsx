                  ...
                  <div className="flex-1">
                    ...
                    {userItem.subscription && (
                      <div className="mt-4 p-4 bg-white/5 rounded-lg border border-white/10">
                        <p className="text-white/60 text-xs uppercase tracking-wider mb-3">Subscription Details</p>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                          ...
                          <div>
                            <p className="text-white/50 text-xs">Subscribed At</p>
                          ...
                          <div>
                            <p className="text-white/50 text-xs">Expires At</p>
                            <p className="text-white text-sm mt-1">
